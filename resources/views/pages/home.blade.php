...
@section('content')
                            ...
                            <div class="row gy-50 gx-40 align-items-center">
                                <div class="col-xxl-7 col-xl-7 col-lg-8">
                                    <div class="hero-1-content pe-xl-4">
                                        ...
                                        <div class="btn-group justify-content-center" data-ani="slideinup" data-ani-delay="0.4s">
                                            <a href="{{ route('projects.index') }}" class="th-btn style2 pill">Explore our projects </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- <section class="popular-sec-1 space">
        <div class="container">
            ...
            <div class="row gy-30 justify-content-center filter-active">
                @foreach($bestProperties as $property)
    ...
    Gallery Area
    ==============================-->
    <div class="gallery-sec-1 space overflow-hidden">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-7">
                    <div class="title-area text-center">
