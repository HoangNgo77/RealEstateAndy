...
<head>
    ...
    <title>Piller-html - Real Estate Home HTML Template - Contact with Us</title>
                ...
                <div class="col-xl-4 col-lg-6 contact-feature-wrap">
                    <div class="contact-feature">
                        ...
                        <div class="media-body">
                            ...
                            <a href="https://www.google.com/maps" class="contact-feature_link">123 Academic Way City, State, 1234, New York City.</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 contact-feature-wrap">
                    <div class="contact-feature">
                        ...
                        <div class="media-body">
                            ...
                            <a href="tel:+011123234567890" class="contact-feature_link">+011 (123) 234 567 890</a>
                            <a href="tel:+09456876543210" class="contact-feature_link">+09 (456) 876 543 210</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 contact-feature-wrap">
                    <div class="contact-feature">
                        ...
                        <div class="media-body">
                            ...
                            <a href="mailto:info@examplemail.edu" class="contact-feature_link">info@examplemail.edu</a>
                            <a href="mailto:admission@examplemail.edu" class="contact-feature_link">admission@examplemail.edu</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <form action="mail.php" method="POST" class="contact-form ajax-contact">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        <textarea name="Your Messsage*" id="message" cols="30" rows="3" class="form-control" placeholder="Your Message *"></textarea>
                                    </div>
